      ...
      <div className="relative w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden my-auto flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-800 bg-slate-950/80">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-white text-sm sm:text-base">Оплата картой / СБП</h3>
              <p className="text-[11px] text-slate-400">Платежный шлюз Platega.io</p>
            </div>
          </div>
          <button
          ...
          <div className="space-y-4">
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-bold text-white">Безопасная оплата</div>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-emerald-500 via-teal-600 to-cyan-600 hover:from-emerald-400 hover:to-cyan-500 text-white font-extrabold py-3.5 px-4 rounded-xl shadow-lg shadow-emerald-500/20 active:scale-[0.98] transition-all flex items-center justify-center gap-2 text-sm mt-2 disabled:opacity-50 disabled:pointer-events-none"
            >
              {isProcessing ? (
                <>
                ...
                <>
                  <span>Оплатить {plan.priceRub} ₽</span>
